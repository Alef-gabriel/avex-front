<style lang="css">
    ...
    *::after {
    ...
    :global(h6, .h6, h5, .h5, h4, .h4, h3, .h3, h2, .h2, h1, .h1) {
    margin-top: 0;
        ...
        <div class="row gx-5 justify-content-center">
            <div class="col-lg-6">
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                    ...
                    <!-- Submit Button-->
                    <div class="d-grid"><button class="btn btn-primary btn-lg" id="submitButton" type="submit" on:click={sendEmail}>Submit</button></div>
                </form>
            </div>
        </div>
    </div>
